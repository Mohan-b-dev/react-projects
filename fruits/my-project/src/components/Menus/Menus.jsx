        ...
        <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6'>
            {MenusData.map((menus)=>(
                ...
                className='bg-white rounded-3xl px-4 py-2 shadow-[0_0_22px_0_rgba(0,0,0,0.15)] flex flex-row justify-around items-center gap-3'>
                    <img src={menus.img} className='w-[60px] mb-4 scale-110 transform -translate-y-0' />
                    <div>
                        <h1 className='text-xl font-semibold'>{menus.title}</h1>
                        <p className='text-lg font-semibold text-secondar'>{menus.price}</p>
                    </div>
                </motion.div>
